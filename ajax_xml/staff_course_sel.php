...
$bSql = mysql_query("SELECT catecode,catename FROM staffCourse WHERE view_state='Y' AND catedeg='2' AND SUBSTRING(catecode,1,4)='".substr($resultCategory,0,4)."' ORDER BY listorder ASC, catecode ASC",$dbconn);
