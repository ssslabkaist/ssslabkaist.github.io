						...
						<TABLE style="width:100%;">
							<TR>
								<TD align="center" style="text-align:center;">
									...
									<div>
										<div class="col-sm-12">
												<input type="password" class="txt_center" maxlength="10" name="pass" <?if ($_SESSION["session_admin_id"] && $adminAuth=="Y") { echo "value='".$row[0]."'"; }?>>
										</div>
									</div>

									<div class="btn_box" style="border-top:none;">
										<ul>
											<li><a class="btn btn-normal" href="#void" onclick="check_form();">삭제완료</a></li>
											<li><a class="btn btn-normal" href="./list.php?tn=<?=$tn?>&spage=<?=$spage?>&cpage=<?=$cpage?>&<?=$subquery?>">취소</a></li>
										</ul>
									</div>
								</td>
							</tr>
