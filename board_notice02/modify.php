...
$m_list_comment1 = stripSlashNotUsed($m_list_comment1);
			...
			<div class=\"divinner col-xs-12\">
				...
				<div class=\"col-xs-12 col-sm-10\">
					<div class=\"col-xs-12 col-sm-5\">
						<input type=\"password\" maxlength=\"10\" name=\"pwd\""; if ($_SESSION["session_admin_id"] && $adminAuth=="Y") { echo " value='$m_pwd'";} echo ">
					</div>
...
if (($_SESSION["session_admin_id"] && $adminAuth=="Y") && $gonggi_admin=="Y" && $m_level=="0") {
	echo "
			<div class=\"divinner col-xs-12\">
				...
				<div class=\"col-sm-10\">
					<label class=\"radio-inline\"><input type=\"radio\" name=\"gonggi_status\" value=\"Y\""; if($m_gonggi_status=="Y") {echo "checked";} echo ">예</label>
					<label class=\"radio-inline\"><input type=\"radio\" name=\"gonggi_status\" value=\"N\""; if($m_gonggi_status=="N") {echo "checked";} echo ">아니요</label>
				</div>
			</div>";
}else{
	echo "
...
?>
			<div class="divinner col-xs-12">
				<label class="col-sm-2 control-label">목록이미지</label>
				<div class="col-sm-10">
					<input type="file" name="list_img1" accept=".gif, .jpg, .png" style="height:40px;" size="50">

<?if($m_list_img1) {?>
					<div>
						<input type="checkbox" name="list_img1_del" value="Y" class="checkbox_board"> 삭제시 체크
						<?=$m_list_img1?>
						<input type="hidden" name="origi_list_img1" value="<?=$m_list_img1?>">
					</div>
<?}?>
...
<?/*
			<div class="divinner col-xs-12">
				...
				<div class="col-sm-10 divinner">
					<textarea rows="5" name="list_comment1" placeholder="내용작성"><?=$m_list_comment1?></textarea>
				</div>
			</div>
*/?>
